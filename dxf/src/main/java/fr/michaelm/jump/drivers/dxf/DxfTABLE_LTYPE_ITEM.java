...
/**
 * The LTYPE item in the TABLES section There is a static reader to read the item in a DXF file and
 * a toString method able to write it in a DXF form
 *
...
public class DxfTABLE_LTYPE_ITEM extends DxfTABLE_ITEM {
  ...
  public static Map<String, DxfTABLE_LTYPE_ITEM> readTable(RandomAccessFile raf)
      throws IOException {
    DxfTABLE_LTYPE_ITEM item = new DxfTABLE_LTYPE_ITEM("DEFAULT", 0);
    Map<String, DxfTABLE_LTYPE_ITEM> table = new LinkedHashMap<String, DxfTABLE_LTYPE_ITEM>();
    DxfGroup group = null;
