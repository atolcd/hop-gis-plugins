...
public class DxfENTITY {
  ...
  private static String pointToDXF(
      Geometry geometry, String layerName, int precision, List<DxfXDATA> xDatas) {
  ...
  private static String lineStringToDXF(
      Geometry geometry, String layerName, int precision, List<DxfXDATA> xDatas) {
  ...
  private static String polygonToDXF(
      Geometry geometry, String layerName, int precision, List<DxfXDATA> xDatas) {
