...
/**
 * The STYLE item in the TABLES section There is a static reader to read the item from a DXF file
...
public class DxfTABLE_STYLE_ITEM extends DxfTABLE_ITEM {
  ...
  public static Map<String, DxfTABLE_STYLE_ITEM> readTable(RandomAccessFile raf)
      throws IOException {
    ...
    while (group != null && !group.equals(ENDTAB)) {
      ...
      if (group.equals(STYLE)) {
        ...
        item.setObliqueAngle(group.getFloatValue());
