...
/**
 * DxfGroup is a group containing a dxf code and a dxf value. The class contains several utils to
 * read and write groups an to format data.
 *
...
public class DxfGroup {
  ...
  private static final DecimalFormat[] decimalFormats =
      new DecimalFormat[] {
  ...
  public DxfGroup(String code, String value) {
    try {
      ...
      System.out.println(
          "Error reading group: \"" + code + "=" + value + "\" is not a valid code/value pair");
    }
  }
