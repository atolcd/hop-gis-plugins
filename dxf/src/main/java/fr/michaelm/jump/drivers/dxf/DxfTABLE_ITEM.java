...
/**
 * This class represent one of the TABLE of the TABLES section. It has as many subclasses as the
...
public class DxfTABLE_ITEM {
  ...
  public static final DxfGroup DIMSTYLE = new DxfGroup(0, "DIMSTYLE");
