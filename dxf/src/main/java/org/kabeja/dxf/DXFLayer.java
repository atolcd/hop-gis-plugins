...
public class DXFLayer {
  ...
  /**
   * Get the bounds for the given filter flag. If true the bounds contains only entity bounds which
   * are on model space. Else returns the bounds which contains the entity bounds which are on
   * paperspace.
   *
   * @param onModelspace
   * @return
