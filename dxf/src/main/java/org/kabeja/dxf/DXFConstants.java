...
public class DXFConstants {
  ...
  public static final Vector DEFAULT_X_AXIS_VECTOR = new Vector(1.0, 0.0, 0.0);
  public static final Vector DEFAULT_Y_AXIS_VECTOR = new Vector(0.0, 1.0, 0.0);
  public static final Vector DEFAULT_Z_AXIS_VECTOR = new Vector(0.0, 0.0, 1.0);
  public static final String DICTIONARY_KEY_GROUP = "ACAD_GROUP";
  public static final String DICTIONARY_KEY_LAYOUT = "ACAD_LAYOUT";
  public static final String DICTIONARY_KEY_MLINESTYLE = "ACAD_MLINESTYLE";
  public static final String DICTIONARY_KEY_PLOTSETTINGS = "ACAD_PLOTSETTINGS";
  public static final String DICTIONARY_KEY_PLOTSTYLENAME = "ACAD_PLOTSTYLENAME";
  public static final String END_STREAM = "EOF";
  public static final String ENTITY_TYPE_3DFACE = "3DFACE";
  public static final String ENTITY_TYPE_3DSOLID = "3DSOLID";

  // Entity types
  public static final String ENTITY_TYPE_ARC = "ARC";
  public static final String ENTITY_TYPE_ATTRIB = "ATTRIB";
  public static final String ENTITY_TYPE_BODY = "BODY";
  public static final String ENTITY_TYPE_CIRCLE = "CIRCLE";
  public static final String ENTITY_TYPE_DIMENSION = "DIMENSION";
  public static final String ENTITY_TYPE_ELLIPSE = "ELLIPSE";
  public static final String ENTITY_TYPE_HATCH = "HATCH";
  public static final String ENTITY_TYPE_IMAGE = "IMAGE";
  public static final String ENTITY_TYPE_INSERT = "INSERT";
  public static final String ENTITY_TYPE_LEADER = "LEADER";
  public static final String ENTITY_TYPE_LINE = "LINE";
  public static final String ENTITY_TYPE_LWPOLYLINE = "LWPOLYLINE";
  public static final String ENTITY_TYPE_MLINE = "MLINE";
  public static final String ENTITY_TYPE_MTEXT = "MTEXT";
  public static final String ENTITY_TYPE_POINT = "POINT";
  public static final String ENTITY_TYPE_POLYLINE = "POLYLINE";
  public static final String ENTITY_TYPE_RAY = "RAY";
  public static final String ENTITY_TYPE_REGION = "REGION";
  public static final String ENTITY_TYPE_SHAPE = "SHAPE";
  public static final String ENTITY_TYPE_SOLID = "SOLID";
  public static final String ENTITY_TYPE_SPLINE = "SPLINE";
  public static final String ENTITY_TYPE_TABLE = "TABLE";
  public static final String ENTITY_TYPE_TEXT = "TEXT";
  public static final String ENTITY_TYPE_TOLERANCE = "TOLERANCE";
  public static final String ENTITY_TYPE_TRACE = "TRACE";
  public static final String ENTITY_TYPE_VERTEX = "VERTEX";
  public static final String ENTITY_TYPE_VIEWPORT = "VIEWPORT";
  public static final String ENTITY_TYPE_XLINE = "XLINE";
  public static final int ENVIRONMENT_VARIABLE_LWDEFAULT = 25;
  public static final int GROUPCODE_STANDARD_FLAGS = 70;
  public static final int GROUPCODE_STANDARD_LAYER = 8;
  public static final int GROUPCODE_SUBCLASS_MARKER = 100;
  ...
  public static final String LAYOUT_DEFAULT_NAME = "Model";
  public static final String OBJECT_TYPE_ACAD_PROXY_OBJECT = "ACAD_PROXY_OBJERCT";
  public static final String OBJECT_TYPE_ACDBDICTIONARYWDFLT = "ACDBDICTIONARYWDFLT";
  public static final String OBJECT_TYPE_ACDBPLACEHOLDER = "ACDBPLACEHOLDER";
  public static final String OBJECT_TYPE_DICTIONARY = "DICTIONARY";
  public static final String OBJECT_TYPE_DICTIONARYVAR = "DICTIONARYVAR";
  public static final String OBJECT_TYPE_DIMASSOC = "DIMASSOC";
  public static final String OBJECT_TYPE_FIELD = "FIELD";
  public static final String OBJECT_TYPE_GROUP = "GROUP";
  public static final String OBJECT_TYPE_IDBUFFER = "IDBUFFER";

  // Object types
  public static final String OBJECT_TYPE_IMAGEDEF = "IMAGEDEF";
  public static final String OBJECT_TYPE_IMAGEDEF_REACTOR = "IMAGEDEF_REACTOR";
  public static final String OBJECT_TYPE_LAYER_FILTER = "LAYER_FILTER";
  public static final String OBJECT_TYPE_LAYER_INDEX = "LAYER_INDEX";
  public static final String OBJECT_TYPE_LAYOUT = "LAYOUT";
  public static final String OBJECT_TYPE_MATERIAL = "MATERIAL";
  public static final String OBJECT_TYPE_MLINESTYLE = "MLINESTYLE";
  public static final String OBJECT_TYPE_OBJECT_PTR = "OBJECT_PTR";
  public static final String OBJECT_TYPE_PLOTSETTINGS = "PLOTSETTINGS";
  public static final String OBJECT_TYPE_RASTERVARIABLES = "RASTERVARIABLES";
  public static final String OBJECT_TYPE_SORTENTSTABLE = "SORTENTSTABLE";
  public static final String OBJECT_TYPE_SPATIAL_FILTER = "SPATIAL_FILTER";
  public static final String OBJECT_TYPE_SPATIAL_INDEX = "SPATIAL_INDEX";
  public static final String OBJECT_TYPE_TABLESTYLE = "TABLESTYLE";
  public static final String OBJECT_TYPE_VBA_PROJECT = "VBA_PROJECT";
  public static final String OBJECT_TYPE_WIPEOUTVARIABLES = "WIPEOUTVARIABLES";
  public static final String OBJECT_TYPE_XRECORD = "XRECORD";
  public static final int PAPER_UNIT_INCH = 0;
  public static final int PAPER_UNIT_MILLIMETER = 1;
  public static final int PAPER_UNIT_PIXEL = 2;
  public static final int PLOT_STYLE_DRAWING_EXTENTS = 1;
  public static final int PLOT_STYLE_DRAWING_LIMITS = 2;
  public static final int PLOT_STYLE_LAST_SCREEN_DISPLAY = 0;
  public static final int PLOT_STYLE_LAYOUT = 5;
  public static final int PLOT_STYLE_SPECIFIECED_VIEW = 3;
  public static final int PLOT_STYLE_SPECIFIECED_WINDOW = 4;
  ...
  public static final String SECTION_END = "ENDSEC";
  ...
  public static final String TABLE_KEY_APPID = "APPID";
  public static final String TABLE_KEY_BLOCK_RECORD = "BLOCK_RECORD";
  public static final String TABLE_KEY_DIMSTYLE = "DIMSTYLE";
  public static final String TABLE_KEY_LAYER = "LAYER";
  public static final String TABLE_KEY_LTYPE = "LTYPE";
  public static final String TABLE_KEY_STYLE = "STYLE";
  public static final String TABLE_KEY_UCS = "UCS";
  public static final String TABLE_KEY_VIEW = "VIEW";
  public static final String TABLE_KEY_VPORT = "VPORT";
}
