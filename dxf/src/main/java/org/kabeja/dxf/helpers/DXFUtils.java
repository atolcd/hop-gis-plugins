...
public class DXFUtils {
  ...
  public static Point getPointFromParameterizedLine(
      Point basePoint, Vector direction, double parameter) {
  ...
  /**
   * Tests if the two points are the same for a given radius. In other words the distance between
   * the two points is lower then the radius.
   *
   * @param p1
   * @param p2
   * @param radius
