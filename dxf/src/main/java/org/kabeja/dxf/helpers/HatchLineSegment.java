...
public class HatchLineSegment {
  ...
  public HatchLineSegment(
      ParametricLine line, double length, double startLength, double[] pattern) {
  ...
  protected void initialize(double startLength) {
    ...
    for (int i = 0; i < pattern.length; i++) {
      ...
      // System.out.println("test Pattern part:"+pattern[i]+" startLength="+startLength+"
      // currentLength:"+l);
      if (l > startLength) {
