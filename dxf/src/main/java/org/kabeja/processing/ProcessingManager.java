...
public class ProcessingManager {
  ...
  public void process(
      InputStream stream, String extension, Map context, String pipeline, OutputStream out)
  ...
  public void process(DXFDocument doc, Map context, String pipeline, OutputStream out)
      throws ProcessorException {
  ...
  public void process(DXFDocument doc, Map context, String pipeline, String sourceFile)
      throws ProcessorException {
    if (this.pipelines.containsKey(pipeline)) {
      try {
        ProcessPipeline pp = (ProcessPipeline) this.pipelines.get(pipeline);
