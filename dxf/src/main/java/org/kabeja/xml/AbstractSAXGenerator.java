...
public abstract class AbstractSAXGenerator extends AbstractConfigurable implements SAXGenerator {
  ...
  /**
   * This method has to be overwritten by any subclass. At this point the XMLGenerator is setup
   * (properties, ContentHandler and DXFDocument) and should emit the XML content to the
   * ContentHandler.
   */
