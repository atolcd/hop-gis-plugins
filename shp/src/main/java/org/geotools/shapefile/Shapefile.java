 ...
 *
 * <p>You construct it with a file name, and later you can read the file's properties, i.e. Sizes,
 * Types, and the data itself.
 *
 * <p>Copyright 1998 by James Macgill.
 *
 * <p>Version 1.0beta1.1 (added construct with inputstream) 1.0beta1.2 (made Shape type constants
 * public 18/Aug/98)
 *
 * <p>This class supports the Shape file as set out in :-<br>
 ...
 *
 * <p>This code is coverd by the LGPL.
 *
 * <p><a href="mailto:j.macgill@geog.leeds.ac.uk">Mail the Author</a>
 */
...
public class Shapefile {
   ...
   * LEDataInputStream directly (recommended)
   *
  ...
  public GeometryCollection read(GeometryFactory geometryFactory)
    ...
    if (file == null) throw new IOException("Failed connection or no content for " + fileName);
  ...
  public static ShapeHandler getShapeHandler(Geometry geom, int ShapeFileDimension)
      throws Exception {
