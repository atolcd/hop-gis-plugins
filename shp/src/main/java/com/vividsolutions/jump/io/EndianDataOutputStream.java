...
/**
 * A class that gives most of the functionality of DataOutputStream, but is endian aware. Uses a
...
public class EndianDataOutputStream {
  ...
  /**
   * write a byte in LittleEndian - this is exactly the same as the BigEndian version since there's
   * no endian in a single byte
   */
  ...
  /**
   * write a byte in BigEndian - this is exactly the same as the LittleEndian version since there's
   * no endian in a single byte
   */
  ...
  /**
   * write a set of bytes in LittleEndian - this is exactly the same as the BigEndian version since
   * there's no endian in a single byte
   */
  ...
  /**
   * write a set of bytes in BigEndian - this is exactly the same as the LittleEndian version since
   * there's no endian in a single byte
   */
