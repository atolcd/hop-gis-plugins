...
public class GeometryBlobWriter {
  ...
  private void writeGeometryCollection(ByteOrderDataOutputStream dos, GeometryCollection geometry)
      throws IOException {

    writeComponents(dos, geometry);
  }

  private void writeMultiPolygon(ByteOrderDataOutputStream dos, MultiPolygon geometry)
      throws IOException {

    writeComponents(dos, geometry);
  }

  private void writeMultiLineString(ByteOrderDataOutputStream dos, MultiLineString geometry)
      throws IOException {

    writeComponents(dos, geometry);
  }

  private void writeMultiPoint(ByteOrderDataOutputStream dos, MultiPoint geometry)
      throws IOException {
  ...
  private void writeLineString(ByteOrderDataOutputStream dos, LineString geometry)
      throws IOException {
  ...
  private void writeComponents(ByteOrderDataOutputStream dos, Geometry geometry)
      throws IOException {
  ...
  private void writeCoordinate(ByteOrderDataOutputStream dos, Coordinate coordinate, int dimension)
      throws IOException {
