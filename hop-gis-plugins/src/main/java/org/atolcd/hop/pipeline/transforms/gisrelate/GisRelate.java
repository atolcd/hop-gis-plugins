...
public class GisRelate extends BaseTransform<GisRelateMeta,GisRelateData> implements ITransform<GisRelateMeta,GisRelateData> {
    ...
    public GisRelate(TransformMeta s, GisRelateMeta meta, GisRelateData data, int c, PipelineMeta t, Pipeline dis) {
    ...
    private Object process(String operator, Geometry inGeometryA, Geometry inGeometryB, Double distance) throws HopException {
