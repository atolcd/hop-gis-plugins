...
public class GisGeometryInfoMeta extends BaseTransformMeta implements ITransformMeta<GisGeometryInfo,GisGeometryInfoData> {
	...
	@Override
	public ITransform createTransform(TransformMeta transformMeta, GisGeometryInfoData data, int cnr, PipelineMeta pipelineMeta,
			Pipeline pipeline) {
