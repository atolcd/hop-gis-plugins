...
import org.atolcd.hop.pipeline.transforms.gisfileoutput.GisFileOutputDialog;
...
public class GisFileOutputMeta extends BaseTransformMeta implements ITransformMeta<GisFileOutput, GisFileOutputData> {
	...
	@Override
	public ITransform createTransform(TransformMeta transformMeta, GisFileOutputData data, int cnr, PipelineMeta pipelineMeta,
			Pipeline pipeline) {
