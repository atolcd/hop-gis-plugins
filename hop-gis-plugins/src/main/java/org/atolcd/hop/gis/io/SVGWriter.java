...
public class SVGWriter extends AbstractFileWriter{
    ...
    public SVGWriter(String fileName, String geometryFieldName, String charsetName) throws HopException {
    ...
    public SVGWriter(Writer writer, String geometryFieldName, String charsetName) throws HopException {
        ...
        for (long key : groups.keySet()) {
    		...
    		for(Feature feature : groups.get(key)){
	            ...
	            if(geometry instanceof Puntal){
	            	...
	            	throw new HopException("Geometry " + GeometryUtils.getGeometryType(geometry) + " is not allowed");
