...
public class GPXWriter extends AbstractFileWriter {
    ...
    public GPXWriter(String fileName, String geometryFieldName, String charsetName) throws HopException {
    ...
    public GPXWriter(Writer writer, String geometryFieldName, String charsetName) throws HopException {
		...
		try{
	        ...
	        while (featureIt.hasNext()) {
	            ...
	            if(geometry instanceof Point){
	            	...
	            	throw new HopException("Only Point , LineString and  MultilineString are allowed.");
