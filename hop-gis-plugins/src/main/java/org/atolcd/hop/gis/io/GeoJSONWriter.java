...
public class GeoJSONWriter extends AbstractFileWriter {
    ...
    public GeoJSONWriter(String fileName, String geometryFieldName, String charsetName) throws HopException {
    ...
    public GeoJSONWriter(Writer writer, String geometryFieldName, String charsetName) throws HopException {
    ...
    public void writeFeatures(List<Feature> features) throws HopException {
        ...
        if (srids.size() > 1) {
            throw new HopException("Error writing features to " + this.geoJsonFileName + " : Mixed SRID are not supported " + srids.toString());
        } else {
