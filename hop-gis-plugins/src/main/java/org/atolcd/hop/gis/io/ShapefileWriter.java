...
public class ShapefileWriter extends AbstractFileWriter {
    ...
    public ShapefileWriter(String fileName, String geometryFieldName, String charsetName) throws HopException {
    ...
    private void checkGeometryCollection(GeometryCollection geometryCollection) throws HopException {
        ...
        if (types.contains("GEOMETRYCOLLECTION")) {
            throw new HopException("Error writing features to " + this.shpFileName + " : GEOMETRYCOLLECTION geometries are not supported");
        }
        ...
        if (srids.size() == 0) {
            ...
            throw new HopException("Error writing features to " + this.shpFileName + " : Mixed SRID are not supported " + srids.toString());
        } else {
        ...
        if (primaryTypes.size() > 1) {
            throw new HopException("Error writing features to " + this.shpFileName + " : Mixed types of geometries are not supported " + types.toString());
        } else {
