...
public class SVGWriter extends AbstractFileWriter {
  ...
  public SVGWriter(String fileName, String geometryFieldName, String charsetName)
      throws HopException {
  ...
  public SVGWriter(Writer writer, String geometryFieldName, String charsetName)
      throws HopException {
  ...
  public void writeFeatures(List<Feature> features) throws HopException {
    ...
    if (this.styleSheet != null) {
      ...
      try {
        ...
        if (this.styleSheetMode != null
            && this.styleSheetMode.equalsIgnoreCase(SVGWriter.RESSOURCE_EMBEDDED)) {
    ...
    for (Feature feature : features) {
      ...
      if (symbolField != null
        ...
        try {
          ...
          throw new HopException(e.getMessage() + feature.getValue(symbolField));
        }
      }
    ...
    AffineTransformation svgTransformation =
        SvgUtil.getGeometryToSvgTransformation(geoExtent, svgExtent);
        ...
        if (geometry instanceof Puntal) {
          ...
          if (geometry instanceof Point) {
            ...
            try {
              ...
              element =
                  new Use(((Point) puntal).getX() - dX, ((Point) puntal).getY() - dY, symbolId);
            ...
            try {
              ...
              for (int i = 0; i < geometry.getNumGeometries(); i++) {
                ...
                ((Group) element)
                    .getElements()
                    .add(new Use(point.getX() - dX, point.getY() - dY, symbolId));
              }
          ...
          throw new HopException(
              "Geometry " + GeometryUtils.getGeometryType(geometry) + " is not allowed");
        }
