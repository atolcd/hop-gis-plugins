...
public class MapInfoReader extends AbstractFileReader {
    ...
    public MapInfoReader(String fileName, String geometryFieldName, String charsetName) throws HopException {
        ...
        try {
            ...
            if (!this.midFileExist) {
                throw new HopException("Missing " + replaceFileExtension(fileName, ".mif", ".mid") + " file");
            }
    ...
    public List<Feature> getFeatures() throws HopException {
        ...
        try {
            ...
            throw new HopException("Error reading features" + this.mifFileName, e);
        } catch (Exception e) {
            throw new HopException("Error reading features" + this.mifFileName, e);
        }
